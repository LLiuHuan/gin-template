...
func (t *Menu) Create(db *gorm.DB) (id int, err error) {
...
func (qb *menuQueryBuilder) WhereId(p database.Predicate, value int) *menuQueryBuilder {
...
func (qb *menuQueryBuilder) WhereIdIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereIdNotIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WherePid(p database.Predicate, value int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WherePidIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WherePidNotIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereName(p database.Predicate, value string) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereLink(p database.Predicate, value string) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereIcon(p database.Predicate, value string) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereLevel(p database.Predicate, value int32) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereSort(p database.Predicate, value int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereSortIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereSortNotIn(value []int) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereIsUsed(p database.Predicate, value int32) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereIsDeleted(p database.Predicate, value int32) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereCreatedAt(p database.Predicate, value time.Time) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereCreatedUser(p database.Predicate, value string) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereUpdatedAt(p database.Predicate, value time.Time) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
...
func (qb *menuQueryBuilder) WhereUpdatedUser(p database.Predicate, value string) *menuQueryBuilder {
	qb.where = append(qb.where, struct {
		prefix string
		value  interface{}
	}{
